...
//                 <h2>OUR BLOG</h2>
//                 <p className='m-0'>Discover health insights, tips, and updates on our blog, guiding you towards better wellness.</p>
//             </div>
...
const Blog = () => {
    ...
    if (isLoading) content = <div>Loading...</div>
    else if (errorMessage) content = <div>{message.error(errorMessage)}</div>
    else if (!isLoading && blogData?.length === 0) content = <Empty />
    else if (!isLoading && !isError && blogData?.length > 0) {
