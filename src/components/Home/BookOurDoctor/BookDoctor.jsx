				...
				<div className="row">
					<div className="col-12 col-md-3 col-lg-3">
						<div className='mb-2 section-title text-center'>
							...
							<p className='m-0 text-secondary'>Schedule an appointment with our experienced team of doctors at Healing Horizon.</p>
						</div>
						<div className="form-text">
							<p>Schedule Your Appointment” At Healing Horizon, we make it easy to book appointments with our skilled team of doctors. Whether you need a routine check-up or specialized care, simply choose your preferred date and time.</p>
							<p>“Expert Care at Your Fingertips” With Healing Horizon, expert medical care is just a click away. Our user-friendly platform allows you to select the doctor of your choice and secure an appointment that fits your schedule.</p>
