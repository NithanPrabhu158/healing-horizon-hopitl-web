        ...
        <section id="doctors" className="doctors">
            <div className="container">
                <div className="section-title text-center mb-3">
                    <h2>OUR DOCTORS</h2>
                    <p className='form-text'>Meet our dedicated team of doctors, each bringing unique expertise and commitment to patient care, ready to partner with you on your journey to better health</p>
                </div>
